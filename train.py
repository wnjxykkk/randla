...
from main import RandLANet, RandLAWithLoss, TrainingWrapper, get_param_groups
...
def train(args):
    ...
    print(123333333333333333333333333333333333333,cfg.learning_rate)
...
if __name__ == "__main__":
    ...
    shutil.copy('main.py',str(args.outputs_dir))
